...
public class BinReverseOddParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "BinReverseOdd.g4"; }
	...
	public BinReverseOddParser(TokenStream input) {
		super(input);
	...
	public static class MainContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(BinReverseOddParser.EOF, 0); }
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BinReverseOddVisitor ) return ((BinReverseOddVisitor<? extends T>)visitor).visitMain(this);
	...
	public static class RevContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BinReverseOddVisitor ) return ((BinReverseOddVisitor<? extends T>)visitor).visitRev(this);
			else return visitor.visitChildren(this);
		}
	}

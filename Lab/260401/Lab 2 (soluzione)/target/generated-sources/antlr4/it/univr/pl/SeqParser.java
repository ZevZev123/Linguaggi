...
public class SeqParser extends Parser {
	...
	public static class MainContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SeqVisitor ) return ((SeqVisitor<? extends T>)visitor).visitMain(this);
	...
	public static class SeqContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SeqVisitor ) return ((SeqVisitor<? extends T>)visitor).visitSeq(this);
			else return visitor.visitChildren(this);
		}
	}

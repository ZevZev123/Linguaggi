...
public class TypedImpLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ADD", "SUB", "MUL", "DIV", "MOD", "POW", "EQQ", "NEQ", "LEQ", "GEQ", 
			"LT", "GT", "NOT", "AND", "OR", "CONCAT", "TOSTR", "IF", "ELSE", "WHILE", 
			"ASSIGN", "OUT", "NOP", "LPAR", "RPAR", "LBRACE", "RBRACE", "SEMICOLON", 
			"BOOL", "INT", "DEC", "STRING", "NAT", "POS", "DIGIT", "POSDIGIT", "STRCHR", 
			"ESC", "TYPE", "ID", "COMMENT", "WS"
		};
	}
	...
	public TypedImpLexer(CharStream input) {
		super(input);
